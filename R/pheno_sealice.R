#' Phenotypic data for Atlantic salmon challenged with sea lice
#'
#' Phenotypic data on 624 Atlantic salmon of breeding program.
#' Genotypes correspond to 59 nuclear families from 90 parents.
#' One year old fish were challenged with sea lice (L. salmonis).
#' After seven days, the fish were measured for body weight (g; \code{weight})
#' and number of lice attached to the fish (\code{lice}).
